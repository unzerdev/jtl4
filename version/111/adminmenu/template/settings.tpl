            ...
            <form action="{$hpSettings.formAction}" method="post">
                ...
                <div class="panel panel-default card mb-3">
                    ...
                    <div class="panel-body card-text">
                        ...
                        <div class="hp-admin-option row mb-2">
                            <div class="hp-admin-option__title col-xs-3 col-3">
                                <label for="hpSettings-pqSelectorPaymentInformation">PQ-Selector für die Zahlungsinformation auf der Bestellabschluss-Seite</label>
                            </div>
                            <div class="hp-admin-option__input col-xs-9 col-9">
                                <input type="text" class="form-control" name="pqSelectorPaymentInformation" id="hpSettings-pqSelectorPaymentInformation" placeholder="#order-confirmation" value="{if isset($hpSettings.config.pqSelectorPaymentInformation)}{$hpSettings.config.pqSelectorPaymentInformation}{else}#order-confirmation{/if}" />
                                <small class="form-text help-block text-muted">Der PHP-Query-Selektor für das Einhängen der Zahlungsinformationen auf der Bestellabschluss-Seite.</small>
                            </div>
                        </div>
                        ...
                        <div class="hp-admin-option row mb-2">
                            <div class="hp-admin-option__title col-xs-3 col-3">
                                <label for="hpSettings-pqMethodPaymentInformation">PQ-Einfügemethode für die Zahlungsinformation auf der Bestellabschluss-Seite</label>
                            </div>
                            <div class="hp-admin-option__input col-xs-9 col-9">
                                <select class="form-control" name="pqMethodPaymentInformation" id="hpSettings-pqMethodPaymentInformation">
                                    <option value="append" {if isset($hpSettings.config.pqMethodPaymentInformation) && $hpSettings.config.pqMethodPaymentInformation == 'append'}selected{/if}>Anhängen (Append)</option>
                                    <option value="prepend" {if isset($hpSettings.config.pqMethodPaymentInformation) && $hpSettings.config.pqMethodPaymentInformation == 'prepend'}selected{/if}>Vorhängen (Prepend)</option>
                                    <option value="before" {if isset($hpSettings.config.pqMethodPaymentInformation) && $hpSettings.config.pqMethodPaymentInformation == 'before'}selected{/if}>Vorstellen (Before)</option>
                                    <option value="after" {if isset($hpSettings.config.pqMethodPaymentInformation) && $hpSettings.config.pqMethodPaymentInformation == 'after'}selected{/if}>Anstellen (After)</option>
                                    <option value="replaceWith" {if isset($hpSettings.config.pqMethodPaymentInformation) && $hpSettings.config.pqMethodPaymentInformation == 'replaceWith'}selected{/if}>Ersetzen (Replace)</option>
                                </select>
                                <small class="form-text help-block text-muted">Die PHP-Query-Einfügemethode für das Einhängen der Zahlungsinformationen auf der Bestellabschluss-Seite.</small>
                            </div>
                        </div>
                    </div>
                </div>
