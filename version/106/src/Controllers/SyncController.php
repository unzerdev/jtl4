...
class SyncController extends Controller
{
    ...
    public function __construct(Plugin $plugin)
    {
        ...
        $this->adapter = $plugin->getContainer()->make(HeidelpayApiAdapter::class);
        $this->model = $plugin->getContainer()->make(OrderMappingModel::class);
        $this->factory = $plugin->getContainer()->make(PaymentMethodModuleFactory::class);
    }
    ...
    private function handleCancel(OrderMappingEntity $entity): void
    {
        ...
        if (!empty($authorization) and $authorization instanceof Authorization) {
