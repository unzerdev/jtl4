                ...
                <div class="panel panel-default card mb-3">
                    ...
                    <div class="panel-body card-text">
                        ...
                        <div class="hp-admin-option row mb-2">
                            ...
                            <div class="hp-admin-option__input col-xs-9 col-9">
                                <input type="text" class="form-control" name="selectorSubmitButton" id="hpSettings-selectorSubmitButton" placeholder="#form_payment_extra .submit" value="{if isset($hpSettings.config.selectorSubmitButton)}{$hpSettings.config.selectorSubmitButton}{else}#form_payment_extra .submit{/if}" />
