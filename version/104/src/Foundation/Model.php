...
abstract class Model
{
    ...
    /**
     * @param NiceDB $database
     */
    public function __construct(NiceDB $database)
    {
    ...
    public function save(Entity $entity): int
    {
        ...
        return (int) $this->database->update($this->getTable(), $this->primaryKey, $entity->getId(), $entity->toObject());
    }
