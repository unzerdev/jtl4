...
namespace Plugin\s360_heidelpay_shop4\Charges;

use Plugin\s360_heidelpay_shop4\Foundation\Entity;
use Plugin\s360_heidelpay_shop4\Foundation\Model;
use stdClass;
 ...
 * @package Plugin\s360_heidelpay_shop4\Charges
 */
class ChargeMappingModel extends Model
{
    public const CHARGE_TABLE = 'xplugin_s360_unzer_shop4_charge';
