...
abstract class HeidelpayPaymentMethod extends PaymentMethod implements NotificationInterface, PaymentStatusInterface
{
    ...
    public function handleNotification($order, $hash, $args): void
    {
        ...
        try {
            ...
            $orderNumber = $this->plugin->getSession()->get(SessionHelper::KEY_ORDER_ID);
    ...
    public function preparePaymentProcess($order)
    {
        ...
        if ($this->duringCheckout) {
            $order->cBestellNr = $this->plugin->getSession()->get(SessionHelper::KEY_ORDER_ID) ?? \baueBestellnummer();
            ...
            $this->plugin->getSession()->set(SessionHelper::KEY_ORDER_ID, $order->cBestellNr);
        }
