(function ($, window, document, undefined) {
    ...
    HeidelpayPayment.prototype.handleFormSubmit = function(event) {
        ...
        .catch(function (error) {
            self.$errorContainer.html(decodeUTF8(error, 'message'));
        });
    };
    ...
    HeidelpayPayment.prototype.createCustomer = function() {
        var Customer = this.unzerInstance.Customer();
        Customer.initFormFields(this.settings.customer || {});

        if (this.customerId) {
            Customer.update(this.customerId, {
